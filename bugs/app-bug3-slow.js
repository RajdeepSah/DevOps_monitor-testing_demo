...
//  ⚠️ BUG: A developer added a "cache warm-up" that actually
//          blocks the response for 5 seconds every single time.
//          In real life this could be:
//          - Missing database index (full table scan)
//          - Accidental N+1 query
//          - Fetching way too much data from an external API
// =============================================
app.get("/data", (req, res) => {
  const { minPrice, maxPrice, inStock } = req.query;

  // 💥 BUG: 5-second artificial delay
