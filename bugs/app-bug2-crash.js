...
app.get("/data", (req, res) => {
  ...
  // ⚠️ BUG: Developer added a "featured product" feature but forgot
  //         that no product has .featured = true — this returns undefined
  const featured = result.find((p) => p.featured === true);
  const featuredName = featured.name; // 💥 TypeError: Cannot read property 'name' of undefined
